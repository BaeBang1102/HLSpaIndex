...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                    <h2><span class="highlight-text">Về chúng tôi</span></h2>
    ...
    <section id="services" class="section-wrapper">
        <div class="container">
            <div class="row">
                ...
                <!-- Section Header -->
                <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                    <h2><span class="highlight-text">Dịch vụ</span></h2>
                </div>
                <!-- Section Header End -->
    ...
    <section id="portfolio" class="bgSection portfolio-section">
        <div class="container">
            <div class="row">
                ...
                <!-- Section Header -->
                <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                    <h2><span class="highlight-text">Bộ sưu tập</span></h2>
        ...
        <div class="portfolio-works wow fadeIn" data-wow-duration="2s">
            ...
            <div id="portfolio-filter" class="portfolio-filter-btn-group">
                <ul>
                    <li>
                        ...
                        <a href="#" data-filter=".web">Facial</a>
                        <a href="#" data-filter=".seo">Scrub</a>
                        <a href="#" data-filter=".works">Stone</a>
                        <a href="#" data-filter=".brands">Massage</a>
                    </li>
                </ul>
            </div>
            <!-- Filter Button End -->
            ...
            <div class="portfolio-items">
                ...
                <div class="item portfolio-item web seo">
                    ...
                    <img src="images/img-portfolio/01.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/01.jpg"
                ...
                <div class="item portfolio-item works seo">
                    ...
                    <img src="images/img-portfolio/02.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/02.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item web">
                    ...
                    <img src="images/img-portfolio/03.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/03.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item web works brands">
                    ...
                    <img src="images/img-portfolio/04.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/04.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item web brands">
                    ...
                    <img src="images/img-portfolio/05.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/05.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item works seo">
                    ...
                    <img src="images/img-portfolio/06.jpg" alt="">
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/06.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item brands seo">
                    ...
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/07.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="item portfolio-item web seo works">
                    ...
                    <div class="portfolio-details-wrapper">
                        <div class="portfolio-details">
                            <div class="portfolio-meta-btn">
                                <ul class="work-meta">
                                    <li class="lighbox"><a href="images/img-portfolio/08.jpg"
                                            class="featured-work-img"><i class="fa fa-search-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="teams-wrapper wow bounceIn">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Section Header -->
                    <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                        <h2><span class="highlight-text-inverted">Chuyên viên</span></h2>
    ...
    <section id="info" class="info-section">
        <div class="container text-xs-center">
            <!-- Section Header -->
            <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                <h2><span class="highlight-text">Thông số</span></h2>
    ...
    <section id="clients" class="clients-section">
        ...
        <div class="container">
            <div class="row">
                <!-- Section Header -->
                <div class="col-md-12 col-sm-12 col-xs-12 section-header wow fadeInDown">
                    <h2><span class="highlight-text">Đánh giá của Khách hàng</span></h2>
                </div>
                <!-- Section Header End -->
                <div class="row">
                        ...
                        <div class="testimonials">
                            <div class="active item">
                                ...
                                <div class="carousel-info">
                                    <img alt="" src="http://keenthemes.com/assets/bootsnipp/img1-small.jpg"
                                        class="pull-left">
                                    <div class="pull-left">
